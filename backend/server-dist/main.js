...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _organiztion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./organiztion */ \"./src/middlewares/organiztion.js\");\n/* harmony import */ var _permission__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./permission */ \"./src/middlewares/permission.js\");\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = ([_permission__WEBPACK_IMPORTED_MODULE_1__[\"default\"]]);\n\n//# sourceURL=webpack:///./src/middlewares/index.js?");

/***/ }),

/***/ "./src/middlewares/organiztion.js":
/*!****************************************!*\
  !*** ./src/middlewares/organiztion.js ***!
  \****************************************/
/*! exports provided: default */
...
/*!*****************************************!*\
  !*** ./src/resolvers/mutation/index.js ***!
  \*****************************************/
/*! exports provided: createPatient, createAppointment, updateAppointment, archiveAppointment, setAppointmentDone, login, verify, createView, editView, activateView, createDefaultView, adjustAppointment, cancelAppointment, singleUpload, multipleUpload, updateClinic, createSnippet */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/***/ "./src/resolvers/query/patient-history.js":
/*!************************************************!*\
  !*** ./src/resolvers/query/patient-history.js ***!
  \************************************************/
/*! exports provided: default */
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @ */ \"./src/index.js\");\n\n\nconst patientHistory = async (_, {\n  id\n}) => {\n  return ___WEBPACK_IMPORTED_MODULE_0__[\"prisma\"].patient.findOne({\n    where: {\n      id\n    }\n  }).appointments({\n    where: {\n      status: 'Archived'\n    }\n  });\n};\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (patientHistory);\n\n//# sourceURL=webpack:///./src/resolvers/query/patient-history.js?");
