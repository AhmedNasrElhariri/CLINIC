export const TRANSLATIONS_AR = {
  ...
  addSalesQuantity: 'أضافه كميات للمنتج',
  cost: 'التكلفه',
  ...
  addNewCourseType: 'أضافه نوع كورس جديد',
  editNewCourseType: 'تعديل نوع الكورس',
  addNewSupplierAccount: 'أضافه حساب موردين جديد',
  editSupplierAccount: 'تعديل حساب موردين', //
  payrollReports: 'تقارير دفع المرتبات',
  payPayslips: 'دفع المرتبات',
  addNewUser: 'أضافه عامل جديد',
  addAdvance: 'أضافه سلفه',
  addIncentives: 'أضافه حوافز',
  addCommission: 'أضافه عموله',
  addDeduction: 'أضافه مستقطع مرتبي',
  deletePayrollUser: 'حذف عامل من المرتبات',
  salary: 'ألمرتب',
  reason: 'السبب',
  ...
  addItem: 'أضافه منتج',
  consume: 'أستهلاك',
  consumeInventory: 'أستهلاك المنتجات',
  ...
  courseUnitsHistory: 'مرجع جلسات الكورس',
