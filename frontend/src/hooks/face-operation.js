...
import { ADD_FACE_OPERATION ,LIST_FACE_PARTATION_OPERATIONS,LIST_FACE_OPERATIONS,DELETE_FACE_OPERATION} from 'apollo-client/queries';
import client from 'apollo-client/client';

function useFaceOperation({ patientId,facePartationNumber, onCreate,onDelete } = {}) {
  ...
  return useMemo(
    ...
    [addFaceOperation,partationFaceOperations,faceOperations,deleteFaceOperation]
  );
}
